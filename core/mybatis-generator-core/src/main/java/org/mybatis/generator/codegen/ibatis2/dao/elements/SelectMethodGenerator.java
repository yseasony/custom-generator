...
public class SelectMethodGenerator extends
    ...
    public SelectMethodGenerator(boolean generateForJava5) {
        super();
    ...
    public void addImplementationElements(TopLevelClass topLevelClass) {
        ...
        sb.append(daoTemplate.getQueryForListMethod(introspectedTable
                .getIbatis2SqlMapNamespace(), "select", "args")); //$NON-NLS-1$
    ...
    private Method getMethodShell(Set<FullyQualifiedJavaType> importedTypes) {
        ...
        //method.addParameter(new Parameter(type, "args")); //$NON-NLS-1$
        method.addParameter(new Parameter(new FullyQualifiedJavaType("Map<String, Object>"), "args")); //$NON-NLS-1$
